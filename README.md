...
手动修改配置文件视频教学（安装部分已过时）：https://www.bilibili.com/video/BV12w411N75f/
...
3. 优化了“蓝图双行槽位”功能，现在卡牌尺寸将会更大，并尽可能的填满可用空间。
4. 修复了蓝图相关功能可能出现崩溃的问题。



### Version 3.1.0

适配依赖模组“模组核心”2.0.0版本，旧版本不再兼容与支持。



### Version 3.0.1

1. 修复配置项“强制修改负重上限”未生效的问题。
2. 修复负重上限在重启游戏后会失效的问题。
3. 修复特质“增加负重上限”图标错误的问题。
